...
def ask_xor(tree):
    ...
    while choice not in [ '0', '1']:
        choice = input(str('would you like to choose 1:{'+ choices[0]+ '} or 2:{'+ choices[1]+ '}\n'))
    return int(choice)
...
def ask_or(tree):
    ...
    while choice not in [ '0', '1', '2']:
        choice = input(str('would you like to choose 1:{'+ choices[0]+ '} or 2:{'+ choices[1]+ '} or 2: for both\n'))
    return int(choice)
